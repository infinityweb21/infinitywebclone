...
export class FirstClassComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({ name: 'keywords', content: 'first class flights, luxury flights, premium travel, first class deals, comfort flights, luxury airline' });
    this.meta.updateTag({ property: 'og:title', content: metaTitle || 'First Class Flights - Infinity Travel' });
    this.meta.updateTag({ property: 'og:description', content: metaDescription || 'Book first class flights with premium comfort and luxury amenities.' });
    this.meta.updateTag({ property: 'og:type', content: 'website' });
    this.meta.updateTag({ name: 'twitter:card', content: 'summary' });
    this.meta.updateTag({ name: 'twitter:title', content: metaTitle || 'First Class Flights - Infinity Travel' });
    this.meta.updateTag({ name: 'twitter:description', content: metaDescription || 'Book first class flights with premium comfort and luxury amenities.' });
