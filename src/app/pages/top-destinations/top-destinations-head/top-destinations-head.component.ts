...
private routeSubHeaderTexts: { [key: string]: string } = {
  london: 'Uncover the best pages of your life by visiting London &amp; make inexplicable memories.',
...
setActiveTabBasedOnRoute(url: string): void {
  ...
  this.activeroute = lastSegment;
   ...
   this.headerText=this.routeHeaderTexts[lastSegment]||this.routeHeaderTexts['default'];
  this.subHeaderText=this.routeSubHeaderTexts[lastSegment]||this.routeSubHeaderTexts['default'];
