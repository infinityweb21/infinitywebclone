export const environment = {
  ...
  FLIGHT_SEAT_REQUEST: 'api/v1/mondee/flight-seat-request',
  FLIGHT_BOOKING: 'api/v1/mondee/flight-book',
  ...
  HOTEL_LIST: 'api/v1/mondee/hotel-list',
  HOTEL_DETAILS: 'api/v1/mondee/hotel-details',
  HOTEL_ALL_ROOMS: 'api/v1/mondee/hotel-all-rooms',
  HOTEL_ALL_IDS: 'api/v1/mondee/hotel-all-ids',
  HOTEL_ROOM_BOOK: 'api/v1/mondee/hotel-room-book',
  HOTEL_PRICE_CHECK: 'api/v1/mondee/hotel-price-check',
  HOTEL_BOOKING_DETAILS: 'api/v1/mondee/hotel-booking-details',
  HOTEL_ROOM_DETAILS: 'api/v1/mondee/hotel-room-details',
